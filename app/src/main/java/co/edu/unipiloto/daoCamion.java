...
public class daoCamion {
    ...
    String tabla="create table if not exists camion(id integer primary key autoincrement, idpropietario integer, idconductor integer, viajes integer, placa text, marca text, estado text)";
